...
/**
  ...
  */
export declare const TELEMETRc path segments represented with placeholders.
 *
 * @example /users/:userID?
 ...
 * @example G1 Survivor Space
 *
 * @note Pool names are generally obtained via [MemoryPoolMXBean#getName()](https://docs.oracle.com/en/java/javase/11/docs/api/java.management/java/lang/managys **SHOULD** be redacted by default and replaced by the
 * value `REDACTED`:
 *
...
//# sourceMappingURL=stable_attributes.d.ts.mapnetwork.peer.port";
/**
 * [OSI application layer](https://wikipedia.org/wiki/Application_layer) or non-OSI equivalent.
 *
 * @example amqp
